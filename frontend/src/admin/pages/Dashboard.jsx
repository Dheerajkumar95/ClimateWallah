...
import { FolderKanban, Wrench, Users, FileText, Mail, Plus, Eye, PenSquare, FileDown, UserSquare, CalendarCheck, Gauge, Compass, BookOpen, Building2 } from "lucide-react";
...
export default function Dashboard() {
  ...
  const stats = [
    { label: "Total Leads", value: d.total_leads, Icon: UserSquare, sub: `${d.new_leads} new` },
    { label: "Bookings", value: d.total_bookings, Icon: CalendarCheck, sub: `${d.new_bookings} new` },
    { label: "Enquiries", value: d.total_enquiries, Icon: Mail, sub: `${d.new_enquiries} new` },
    { label: "Assessments", value: d.assessment_completions, Icon: Gauge },
    { label: "Finder Results", value: d.certification_completions, Icon: Compass },
    { label: "Follow-ups Due", value: d.follow_up_leads, Icon: UserSquare },
    { label: "Projects", value: d.total_projects, Icon: FolderKanban, sub: `${d.published_projects} published` },
    { label: "Services", value: d.total_services, Icon: Wrench },
    { label: "Industries", value: d.total_industries, Icon: Building2 },
    { label: "Team", value: d.total_team, Icon: Users },
    { label: "Blog Posts", value: d.total_blogs, Icon: FileText, sub: `${d.draft_blogs} drafts` },
    { label: "Resource Downloads", value: d.resource_downloads, Icon: BookOpen },
  ];

  const actions = [
    { to: "/admin/leads", label: "View Leads", Icon: UserSquare },
    { to: "/admin/bookings", label: "View Bookings", Icon: CalendarCheck },
