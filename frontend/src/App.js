...
import {
  PartnersAdmin,
  EventsAdmin,
  CertificationRulesAdmin,
  AssessmentQuestionsAdmin,
} from "@/admin/pages/ContentAdmins";
          ...
          <SettingsProvider>
            ...
            <Routes>
              <Route element={<PublicLayout />}>
                ...
                <Route
                  path="/certification-finder"
                  element={<CertificationFinder />}
                />
                ...
                <Route
                  path="/tools/ghg-calculator"
                  element={<GHGCalculator />}
                />
              ...
              >
                ...
                <Route
                  path="certification-rules"
                  element={<CertificationRulesAdmin />}
                />
                <Route
                  path="assessment-questions"
                  element={<AssessmentQuestionsAdmin />}
                />
                <Route
                ...
                <Route
                  ...
                  element={<PortalClients />}
                />
                <Route
                  path="certification/reviewers"
                  element={<PortalReviewers />}
                />
                <Route
              ...
              <Route
                path="/portal"
                element={
                  <PortalProtectedRoute roles={["client"]}>
              ...
              <Route
                path="/reviewer"
                element={
                  <PortalProtectedRoute roles={["reviewer"]}>
                    <PortalLayout role="reviewer" />
                  </PortalProtectedRoute>
                }
              >
                <Route
